...
{   
	...
	void SmartMove          (const sc2::Unit * attacker, const sc2::Point2DI & targetPosition, CCBot & bot);
    ...
    void SmartBuild         (const sc2::Unit * builder,   const sc2::UnitTypeID & buildingType, sc2::Point2DI pos, CCBot & bot);
